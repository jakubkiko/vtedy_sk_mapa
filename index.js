...
async function initMap() {
  ...
  // kniznica je vzdy prve slovo bez Library a lowercase (facepalm)
  ...
  for (let i = 0; i < features.length; i++) {
    ...
    const htmlcode = "<a href='https://vtedy.tasr.sk/zoom/" + features[i].content + "'><img src='https://vtedy.tasr.sk/api/item/" + features[i].content + "/thumbnail/2'></a>";
